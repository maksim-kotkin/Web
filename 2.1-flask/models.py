import datetime
import os
from sqlalchemy import  ForeignKey, create_engine, Integer, String, DateTime, func
...
class Advertisement(Base):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True)
    owner_id:Mapped[int] =  mapped_column(Integer, ForeignKey('app_user.id', ondelete='CASCADE'))
